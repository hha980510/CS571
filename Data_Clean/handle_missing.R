...
# Load raw data
nvda_data <- readRDS("Data/nvda_data_raw.rds")
macro_data_raw <- readRDS("Data/macro_data_raw.rds")
...
# Save cleaned data
saveRDS(nvda_data_after_missing_handling, "Data/nvda_data_after_missing_handling.rds")
saveRDS(macro_data_combined_daily, "Data/macro_data_combined_daily.rds")
