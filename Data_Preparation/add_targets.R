...
# Load data
nvda_data <- readRDS("Data/cleaned_nvda_data.rds")
...
# Save output
saveRDS(nvda_data, file = "Data/nvda_data_with_targets.rds")
write.csv(nvda_data, "Data/nvda_data_with_targets.csv", row.names = FALSE)
