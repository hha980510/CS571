...
# Load data
nvda_data <- readRDS("Data/nvda_data_structured_clean.rds")
...
write.csv(nvda_data_df, "Data/cleaned_nvda_data.csv", row.names = FALSE)
saveRDS(nvda_data_df, "Data/cleaned_nvda_data.rds")
