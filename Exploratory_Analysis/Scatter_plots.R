...
# Purpose:
#   Visualize relationships between key technical indicators
#   and NVIDIA's stock price using scatter plots.
#
# Features used:
#   - RSI (14-day), MACD, 20-day Rolling Volatility,
#     Lagged Price, Volume, Log Returns, Closing Price
#
# Output:
#   Scatter plots saved as PNG files in the 'Figures/' directory:
#     • RSI vs Close Price
#     • Volatility vs Log Return
#     • MACD vs Lagged Price
#     • Volume vs Close Price
#
# Libraries Used: quantmod, TTR, ggplot2, dplyr
# Data Source: 'nvda_data_fully_engineered.rds' (preprocessed)
# =====================================================
